...
(function () {
    ...
    Node = (function () {
        ...
        Node.prototype.expand = function () {
            ...
            if (this.children.length) {
                ...
                this.row.removeClass("collapsed")
                    .addClass("expanded");
    ...
    methods = {
        ...
        loadBranch: function (node, rows) {
            var settings = this.data("treetable")
                .settings,
                tree = this.data("treetable")
                    .tree;
            ...
            if (node == null) { // Inserting new root nodes
                ...
                var lastNode = this.data("treetable")
                    .findLastNode(node);
        ...
        move: function (nodeId, destinationId) {
            ...
            node = this.data("treetable")
                .tree[nodeId];
            destination = this.data("treetable")
                .tree[destinationId];
            this.data("treetable")
            ...
            if ($.isNumeric(columnOrFunction)) {
                sortFun = function (a, b) {
                    ...
                    extractValue = function (node) {
                        var val = node.row.find("td:eq(" + columnOrFunction + ")")
                            .text();
